  ...
  providers: [
    {
      ...
      useFactory: () => (): BlockScrollStrategy => {
...
export class SearchComponent implements OnChanges, OnInit {
  ...
  // 搜索发生后发出的事件
  @Output() search: EventEmitter<SafeAny> = new EventEmitter<SafeAny>();
  ...
  ngOnInit(): void {
    ...
    this.searchControl.valueChanges
      ...
      .subscribe(value => {
        this._httpClient.post('api/common/search', { query: value }).subscribe((resultSets: SafeAny) => {
          // 存储结果集

...
import { Message, MessagesService } from 'app/layout/common/messages';
...
export class MessagesComponent implements OnInit, OnDestroy {
  ...
  @ViewChild('messagesPanel') private _messagesPanel: TemplateRef<SafeAny>;
  ...
  ngOnInit(): void {
    // 订阅消息更改
    this._messagesService.messages$.pipe(untilDestroyed(this)).subscribe((messages: Message[]) => {
      // 加载消息

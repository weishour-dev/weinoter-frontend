...
export const defaultNavigation: WsNavigationItem[] = [
  {
    id: 'example',
    title: 'Example',
    type: 'basic',
  ...
  },
  {
    ...
    children: [
      ...
      {
        id: 'user-interface.ws-components',
        title: 'ws Components',
        type: 'basic',
        icon: 'heroicons_outline:chip',
        link: '/ui/ws-components',
      },
      {
  ...
  },
  {
    id: 'documentation',
    title: 'Documentation',
    subtitle: 'Everything you need to know about ws',
    type: 'group',
    icon: 'heroicons_outline:support',
    children: [
      {
...
export const compactNavigation: WsNavigationItem[] = [
  {
    id: 'dashboards',
    title: 'Dashboards',
    tooltip: 'Dashboards',
...
export const futuristicNavigation: WsNavigationItem[] = [
  {
    id: 'example',
    title: 'Example',
    type: 'basic',
...
export const horizontalNavigation: WsNavigationItem[] = [
  {
    id: 'example',
    title: 'Example',
    type: 'basic',

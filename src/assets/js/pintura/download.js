var FilePondPluginGetFile = (function () {
  'use strict';
  /**
   * 通过插入下载图标来注册下载组件
   */
  ...
  let result$3 = null;
  var isBrowser = () => {
    if (result$3 === null) result$3 = typeof window !== 'undefined' && typeof window.document !== 'undefined';
    return result$3;
  };
  ...
  if (isBrowser()) document.dispatchEvent(new CustomEvent('FilePond:pluginloaded', { detail: plugin }));

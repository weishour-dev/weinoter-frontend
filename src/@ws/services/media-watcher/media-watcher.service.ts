...
export class WsMediaWatcherService {
  private _onMediaChange: ReplaySubject<{ matchingAliases: string[]; matchingQueries: SafeAny }> = new ReplaySubject<{
    matchingAliases: string[];
    matchingQueries: SafeAny;
  }>(1);
   ...
   * _onMediaChange访问器
   */
  get onMediaChange$(): Observable<{ matchingAliases: string[]; matchingQueries: SafeAny }> {

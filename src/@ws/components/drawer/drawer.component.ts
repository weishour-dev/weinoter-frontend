...
import { WsDrawerMode, WsDrawerPosition, WsDrawerService } from '@ws/components/drawer';
...
export class WsDrawerComponent implements OnChanges, OnInit, OnDestroy {
  ...
  // position更改后发出的事件
  @Output() readonly positionChanged: EventEmitter<WsDrawerPosition> = new EventEmitter<WsDrawerPosition>();

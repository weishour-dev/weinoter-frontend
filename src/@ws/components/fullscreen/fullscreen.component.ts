...
import { FSDocument, FSDocumentElement } from '@ws/components/fullscreen';
...
@Component({
  ...
  standalone: true,
  imports: [NgTemplateOutlet, MatIconModule, MatButtonModule, MatTooltipModule, TranslocoModule],
})
export class WsFullscreenComponent implements OnInit {
  // 图标的模板
  @Input() iconTpl: TemplateRef<SafeAny>;
  // 切换按钮的工具提示

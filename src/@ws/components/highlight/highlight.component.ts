...
import { WsHighlightService } from '@ws/components/highlight';
...
export class WsHighlightComponent implements OnChanges, AfterViewInit {
  ...
  @Input() lang: string;
  @ViewChild(TemplateRef) templateRef: TemplateRef<SafeAny>;

  highlightedCode: string;
  private _viewRef: EmbeddedViewRef<SafeAny>;

...
import { WsMockApiHandler, WsMockApiMethods } from '@ws/lib/mock-api';
...
export class WsMockApiService {
   ...
   * @private
   */
  private _registerHandler(method: WsMockApiMethods, url: string, delay?: number): WsMockApiHandler {
